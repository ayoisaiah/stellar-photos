    ...
    <div class="photo-settings">
      <div>
        ...
        <select id="select-photo-frequency"
          ...
          <option value="newtab" ?selected=${settings.photoFrequency ===
            'newtab'}>On every new tab (default)</option>
          <option value="every15minutes" ?selected=${settings.photoFrequency ===
            'every15minutes'}>Every 15 minutes</option>
          <option value="everyhour" ?selected=${settings.photoFrequency ===
            'everyhour'}>Every hour</option>
          <option value="everyday" ?selected=${settings.photoFrequency ===
            'everyday'}>Every day</option>
        </select>
      </div>
