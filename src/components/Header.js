    ...
    return (
      ...
      <header className="header">
        ...
        <div className="header-content">
          ...
          />
          <nav className="links">
            <a href="https://github.com/ayoisaiah/stellar-photos" className="github-corner" aria-label="View source on Github">
    					<svg className="github-corner__svg" width="75" height="75" viewBox="0 0 250 250" aria-hidden="true">
